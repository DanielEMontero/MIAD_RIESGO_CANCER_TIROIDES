...
Obesidad: Se indica si el paciente tiene obesidad de acuerdo si su índice de masa corporal es superior a 25. La obesidad se ha relacionado con aumento del riesgo de malignidad en varios tumores, incluido el tiroideo. 
Diabetes: Se coloca si el paciente presenta diabetes mellitus de cualquier tipo. Puede influir en procesos inflamatorios y hormonales que alteran funciones tiroideas. 
...
6.	Procedimiento paso a paso: 
 1.	Se debe instalar el tablero de acuerdo con las instrucciones del manual de instalación, va a encontrar una interfaz con los espacios para llenar las variables, va a observar una imagen de como la que se encuentra en la figura 1. 
![alt text](image.png)
